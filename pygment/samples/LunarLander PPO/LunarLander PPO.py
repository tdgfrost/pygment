...
for target_reward in [140]:
    ...
    # Temporarily set save_from to 1000, i.e., disabled save
    agent.train(target_reward=target_reward, save_from=1000, save_interval=10, iterations=100000, sample_episodes=2000,
